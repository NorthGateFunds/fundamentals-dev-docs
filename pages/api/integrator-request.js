...
// Vercel/Next API route (source of truth for Vercel).
...
//
// IMPORTANT: This file is intentionally self-contained (no imports) to avoid
// module format / bundling / runtime mismatches.

// Ensure Node runtime (not Edge)
export const config = { runtime: "nodejs" };

// Change this string any time to verify Vercel is running THIS file.
const HANDLER_VERSION = "integrator-request@2026-01-15T04:45Z";
...
function send(res, status, body) {
  ...
  res.setHeader("x-fw-entry", "pages/api/integrator-request.js");
